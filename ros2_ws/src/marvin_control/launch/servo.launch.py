...
def generate_launch_description():
    ...
    # RViz configuration
    rviz_config_file = os.path.join(get_package_share_directory("marvin_control"), "config", "marvin_rviz_config.rviz")
    ...
    container = launch_ros.actions.ComposableNodeContainer(
        ...
        composable_node_descriptions=[
            ...
            launch_ros.descriptions.ComposableNode(
                ...
                parameters=[{"child_frame_id": "/marvin_base", "frame_id": "/world"}],
            ),
        ],
        output="screen",
    )
