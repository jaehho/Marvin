...
bool custom_interfaces__msg__pose_landmark__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_interfaces.msg._pose_landmark.PoseLandmark", full_classname_dest, 49) == 0);
  }
  custom_interfaces__msg__PoseLandmark * ros_message = _ros_message;
  {  // label
...
{
  /* NOTE(esteve): Call constructor of PoseLandmark */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_interfaces.msg._pose_landmark");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PoseLandmark");
